...
6. `git submodule add -b master https://github.com/<USERNAME>/<USERNAME>.github.io public`. This creates a git [submodule][]. Now when you run the `hugo` command to build your site to `public`, the created `public` directory will have a different remote origin (i.e. hosted GitHub repository).
